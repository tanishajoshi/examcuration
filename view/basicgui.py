...
def start():
    ...
    def add():
        ...
        Label(add_question_window, text='Question:', font=("Helvetica", 15)).place(relx = 0, rely = 0.1, anchor='w')
        ...
        Label(add_question_window, text='Answer:', font=("Helvetica", 15)).place(relx = 0, rely = 0.3, anchor='w')
        answer_entry = Entry(add_question_window, width=82)
        answer_entry.place(relx = 0.55, rely = 0.3, anchor='center')   
        
        ''' Text bar to enter tags. '''
        Label(add_question_window, text='Tags:', font=("Helvetica", 15)).place(relx = 0, rely = 0.5, anchor='w')
        ...
        add_button=Button(add_question_window,text="Add Question", font=("Helvetica", 10), width=15,height=3,command=add_question, bg='white')
    ...
    def edit():
        ...
        ''' Text bar to enter questions and answers. '''
        Label(edit_question_window, text='Question:', font=("Helvetica", 15)).place(relx = 0, rely = 0.3, anchor='w')
        question_entry = Entry(edit_question_window, width=80)
        question_entry.place(relx = 0.56, rely = 0.3, anchor='center')
        
        ''' Text bar to enter answers. '''
        Label(edit_question_window, text='Answer:', font=("Helvetica", 15)).place(relx = 0, rely = 0.5, anchor='w')
        answer_entry = Entry(edit_question_window, width=82)
        answer_entry.place(relx = 0.55, rely = 0.5, anchor='center')         
        
        
        ''' Change button. '''
        change_button=Button(edit_question_window,text="Change Question/Answer", font=("Helvetica", 10), width=20,height=5,command=edit_question, bg='white')
    ...
    def delete():
        ...
        ''' Text bar to find questions. '''
        Label(delete_question_window, text='Question ID:', font=("Helvetica", 15)).place(relx = 0, rely = 0.1, anchor='w')
        question_id_entry = Entry(delete_question_window, width=75)
        question_id_entry.place(relx = 0.58, rely = 0.1, anchor='center')
        
        ''' Delete button. '''
        delete_button=Button(delete_question_window,text="Delete", font=("Helvetica", 10), width=20,height=5,command=delete_question, bg='white')
    ...
    ''' Add question, edit question, view questions and delete question buttons. '''
    add_button=Button(ui,text="Add Question", font=("Helvetica", 10), width=15,height=5,command=add, bg='white')
    add_button.place(x=90,y=25)

    edit_button=Button(ui,text="Edit Question", font=("Helvetica", 10), width=15,height=5,command=edit, bg='white')
    edit_button.place(x=90,y=125)

    delete_button=Button(ui,text="Delete Question", font=("Helvetica", 10), width=15,height=5,command=delete, bg='white')
    delete_button.place(x=90,y=225)

    view_button=Button(ui,text="View Questions", font=("Helvetica", 10), width=15,height=5,command=view, bg='white')
